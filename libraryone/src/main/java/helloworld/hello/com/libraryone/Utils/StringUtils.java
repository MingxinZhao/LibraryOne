...
//	 ----------------------------------
    ...
    /*    String htmlLinkText = "";
        ...
        String head = test.substring(0,begin);
        String endS = test.substring(endL+4);
        htmlLinkText = test.substring(3, endL+3);
//        htmlLinkText = "<a href=\"http://www.baidu.com/\"><u>"+htmlLinkText+" </u></a>";
        String res = head+htmlLinkText+endS;
//        res = res.replace("\n","<br/>");
        ...
        if(text instanceof Spannable){
            ...
            sp.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.color_3C878F)), begin, endL+2, 0);
            URLSpan[] urls=sp.getSpans(0, end, URLSpan.class);
            SpannableStringBuilder style=new SpannableStringBuilder(text);
            style.clearSpans();//should clear old spans
            for(URLSpan url : urls){
                CommentURLSpan myURLSpan = new CommentURLSpan(url.getURL(),userId,mContext);
